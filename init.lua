...
Services = {
    ...
    status = "http://erindor.sytes.net/login.php", --./client_entergame | ./client_topmenu
...
if ENABLE_SERVERS then
    ...
    Servers_init = {
        ...
        --
        ["http://erindor.sytes.net/login.php"] = {
            port = 80,
            protocol = 1511,
            httpLogin = true,
            useAuthenticator = false
...
g_app.setName("Erindor Client");
g_app.setCompactName("erindorclient");
g_app.setOrganizationName("erindor");
