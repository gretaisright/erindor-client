...
addCheckBox("timers", "MW & WG Timers", true, leftPanel, "Show times for Magic Walls and Wild Growths.")
if true then
  local activeTimers = {}
...
addCheckBox("antiKick", "Anti - Kick", true, leftPanel, "Turn every 10 minutes to prevent kick.")
if true then
