...
SpellInfo = {
    Default = {
        ...
        ['Ultimate Water Strike'] = {id = 302, name = 'Ultimate Water Strike', words = 'exori max aqua', type = 'Instant', level = 600, mana = 1000, soul = 0, maglevel = 0, icon = '', clientId = 189, group = {[1] = 2000}, needTarget = false, parameter = false, range = 7, exhaustion = 6000, premium = true, vocations = {2, 6}, special = false, source = 0},
        ['Ultimate Death Strike'] = {id = 303, name = 'Ultimate Death Strike', words = 'exori max mort', type = 'Instant', level = 600, mana = 1000, soul = 0, maglevel = 0, icon = '', clientId = 190, group = {[1] = 2000}, needTarget = false, parameter = false, range = 7, exhaustion = 6000, premium = true, vocations = {1, 5}, special = false, source = 0},
        ['World Slash'] = {id = 304, name = 'World Slash', words = 'exori max', type = 'Instant', level = 700, mana = 1200, soul = 0, maglevel = 0, icon = '', clientId = 191, group = {[1] = 2000}, needTarget = false, parameter = false, range = -1, exhaustion = 6000, premium = true, vocations = {4, 8}, special = false, source = 0},
        ['Deep Forest Emergence'] = {id = 305, name = 'Deep Forest Emergence', words = 'exevo max mas tera', type = 'Instant', level = 700, mana = 2000, soul = 0, maglevel = 0, icon = '', clientId = 192, group = {[1] = 4000}, needTarget = false, parameter = false, range = -1, exhaustion = 12000, premium = true, vocations = {2, 6}, special = false, source = 0},
        ['Super Nova'] = {id = 306, name = 'Super Nova', words = 'exevo max mas flam', type = 'Instant', level = 700, mana = 2000, soul = 0, maglevel = 0, icon = '', clientId = 193, group = {[1] = 4000}, needTarget = false, parameter = false, range = -1, exhaustion = 12000, premium = true, vocations = {1, 5}, special = false, source = 0},
        ['Shining Road'] = {id = 307, name = 'Shining Road', words = 'exevo via san', type = 'Instant', level = 700, mana = 1200, soul = 0, maglevel = 0, icon = '', clientId = 194, group = {[1] = 2000}, needTarget = false, parameter = false, range = 4, exhaustion = 4000, premium = true, vocations = {3, 7}, special = false, source = 0},
        ['One Inch Punch'] = { id = 308, name = 'One Inch Punch', words = 'exori max pug', type = 'Instant', level = 700, mana = 1200, soul = 0, maglevel = 0, icon = '', clientId = 195, group = { [1] = 2000 }, needTarget = true, parameter = false, range = 1, exhaustion = 6000, premium = true, vocations = {9, 10}, special = false, source = 0, },
    }
}
