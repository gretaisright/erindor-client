...
local default_info = {
    -- hint 1
    {
        ...
        Title = "Use !getvip for 3 VIP days!",
        description = "For the full list of commands, their description and a example of usage visit http://erindor.sytes.net/?commands"
    },
    ...
    -- hint 2
    {
        image = "images/randomhint",
        Title = "Costum Spells!",
        description = "Check all new spells, the rebalance of old ones and much information like base power and cooldowns at http://erindor.sytes.net/?spells"
    },
}
